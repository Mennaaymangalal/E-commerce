...
import removeProductFromWishlist from '../../Services/removeProdectFromWishlist'
  ...
  const handleHeartClick = async (e) => {
    ...
    try {
      if (newState) {
        ...
        localStorage.setItem(`wishlist-${product._id}`, "true"); // Save state
      } else {
        // Remove from wishlist
        await removeProductFromWishlist(product._id);
        localStorage.setItem(`wishlist-${product._id}`, "false"); // Save state
      }
    } catch (error) {
