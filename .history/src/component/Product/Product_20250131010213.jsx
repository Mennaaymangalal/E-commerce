...
export default function Product({product , index}) {
  ...
  return (
    ...
    >
      ...
      <Button isLoading={isLoading} onPress={()=> async function addProductWishlist(productId) {
    ...
    console.log(data)
  }(product._id, setIsLoading)} href="#" className="flex items-center justify-center rounded-md bg-slate-900 dark:bg-slate-950 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
