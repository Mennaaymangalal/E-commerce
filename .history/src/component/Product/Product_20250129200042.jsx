...
export default function Product({product , index}) {
  ...
  return (
    <>
       <div key={index} className="relative m-5 flex w-full py-3 flex-col overflow-hidden rounded-lg border border-gray-100 dark:bg-slate-900 dark:border-slate-950 bg-white shadow-md">
      ...
      <Button isLoading={isLoading} onPress={()=>AddProuctToCart(product._id, setIsLoading)} href="#" className="flex items-center justify-center rounded-md bg-slate-900 dark:bg-slate-950  py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
