...
export default function Product({product , index}) {
  ...
  return (
    <>
       <div key={index} className="relative m-5 flex w-full align-middle justify-center flex-col overflow-hidden rounded-lg border border-gray-100 dark:bg-slate-900 dark:border-slate-950 bg-white shadow-md">
