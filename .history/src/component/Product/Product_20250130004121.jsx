...
export default function Product({product , index}) {
  ...
  return (
    <>
     ...
     <button
      onClick={handleClick}
      className="flex items-center justify-center border border-gray-900 dark:border-white rounded-md bg-transparent px-5 py-2.5 text-center text-sm font-medium text-gray-900 dark:text-white hover:border-red-500 focus:outline-none"
    >
      <svg
