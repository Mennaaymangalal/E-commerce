...
export default function Product({product , index}) {
  ...
  return (
    <>
     ...
     <button
      onClick={handleClick}
      className="flex items-center justify-center rounded-md bg-transparent px-5 py-2.5 text-center text-sm font-medium text-gray-900 dark:text-white500 focus:outline-none"
    >
      <svg
