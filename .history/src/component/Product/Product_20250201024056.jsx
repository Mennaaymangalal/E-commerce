...
export default function Product({product , index}) {
  ...
  return (
    <>
       ...
       <img className=" w-full h-auto object-cover rounded-lg transition-transform duration-500 ease-in-out group-hover:scale-110" src={product.imageCover} alt={product.title} />
