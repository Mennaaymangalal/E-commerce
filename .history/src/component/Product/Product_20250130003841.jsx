...
export default function Product({product , index}) {
  ...
  return (
    <>
     ...
     <button  onClick={addProductWishlist || handleClick}
      className="flex items-center justify-center rounded-md bg-transparent px-5 py-2.5 text-center text-sm font-medium text-gray-900 dark:text-white 500 focus:outline-none"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="mr-2 h-6 w-6"
        fill={isRed ? "red" : "currentColor"} // Toggle fill color
        viewBox="0 0 24 24"
        stroke="none"
      >
