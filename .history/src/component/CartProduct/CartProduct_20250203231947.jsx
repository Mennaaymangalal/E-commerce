          ...
          <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
            ...
            <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
              <div className="flex items-stretch border-gray-100">
                <button disabled={productCount === 1 || decrement}  onClick={{()=>setProductCount(productCount - 1)} , UpdateCartProduct(product.product._id , productCount + 1 , setDecrement,setIncrement ,product.count) }
                ...
                <button disabled={increment} onClick={()=>setProductCount(productCount + 1)}
