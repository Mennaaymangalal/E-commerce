            ...
            <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
              <div className="flex items-stretch border-gray-100">
                ...
                <input
                  ...
                  type="number"
                  value={productCount} onChange={(e) => setProductCount(e.target.value)} onBlur={(e)=>setProductCount(product.product._id , e.target.value ,setDecrement, setIncrement,product.count)}
                  min="1"
