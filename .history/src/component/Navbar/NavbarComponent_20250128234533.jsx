...
export default function NavbarComponent() {  
  ...
  return (
    ...
    {  
     ...
     <div onClick={()=> (setIsDarkMOde(!isDarkMode))} className="flex flex-col justify-end ml-3">
    ...
    <label className="relative cursor-pointer p-2"  htmlFor="light-switch">
     ...
     { 
      isLogedIn ?
      <NavbarItem>
          <Button onPress={logout} as={NavLink} color="primary" to={"register"} variant="bordered">
            Log out
          </Button>
        </NavbarItem> 
        :
