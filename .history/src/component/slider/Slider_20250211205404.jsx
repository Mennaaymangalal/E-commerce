      ...
      <div className="overflow-hidden rounded-lg shadow-lg relative w-full">
        ...
        >
          ...
          <div className="carousel-item bg-white dark:bg-gray-800 p-6 flex-shrink-0 w-full">
            ...
            />
            <h2 className="text-xl font-semibold mt-4"> Sale Up To 70%!</h2>
            <p className="text-gray-600 dark:text-gray-400">            
          ...
          <div className="carousel-item bg-white dark:bg-gray-800 p-6 flex-shrink-0 w-full">
            <img
              ...
              className="w-full h-64 object-cover rounded-md"
            />
            <h2 className="text-xl font-semibold mt-4">New Season</h2>
            <p className="text-gray-600 dark:text-gray-400 textupper">
             time for change
            </p>
          </div>
