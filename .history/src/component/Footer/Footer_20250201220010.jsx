...
export default function Footer() {
  return (
    <>
    {/* lg:max-w-screen-xl */}
    <div className="border-t px-4 pt-10 mx-auto sm:max-w-xl md:max-w-full  lg:max-w-screen-xl md:px-24 lg:px-8">
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
    <a href="/" aria-label="Go home" title="Company" className="flex items-center justify-start">
     <div className="w-20 h-20 ">
    <img src={img} alt="Freshcard Logo" className="object-contain w-full h-full ms-5" />
      </div>
  <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase dark:text-white">
    ...
    <div className="space-y-2 text-sm flex columns-1 items-center justify-start">
      <p className="dark:text-white text-base font-bold tracking-wide text-gray-900">Contacts</p>
      <div className="flex">
    ...
    <div>
      <span className="dark:text-white text-base font-bold tracking-wide text-gray-900">Social</span>
      <div className="flex items-center mt-1 space-x-3">
        <a href="/" className="dark:text-white text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
