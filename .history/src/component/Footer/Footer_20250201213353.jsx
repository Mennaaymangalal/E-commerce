...
export default function Footer() {
  ...
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <a href="/" aria-label="Go home" title="Company" className="flex items-center justify-center">
     <div className="w-20 h-20 ms-8">
    <img src={img} alt="Freshcard Logo" className="object-contain w-full h-full" />
      </div>
