...
export default function Footer() {
  ...
  <div className="grid grid-cols-1 gap-10 row-gap-6 sm:grid-cols-2 lg:grid-cols-4 items-start">
  ...
  <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
    ...
    <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
      <li>
        <a
          href="/"
          className="dark:text-white text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400"
        >
          F.A.Q
        </a>
      </li>
