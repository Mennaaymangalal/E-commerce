...
export default function Footer() {
  ...
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center ms-4">
         <img  src={logo} alt="Logo" height="80" width="80"></img>
        <span className="dark:text-white ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">FRESHCARD</span>
      </a>
