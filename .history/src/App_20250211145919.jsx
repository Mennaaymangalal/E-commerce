...
import UpdateLoggeduserpassword from "./pages/UpdateLoggeduserpassword/UpdateLoggeduserpassword";
...
function App() {
  const router = createBrowserRouter([
    {path: "",element: <MainLayout />,children: [
        ...
        {path: "/updateLoggeduserpassword",element: (<ProtectedLoginRouting><UpdateLoggeduserpassword /></ProtectedLoginRouting>),},
