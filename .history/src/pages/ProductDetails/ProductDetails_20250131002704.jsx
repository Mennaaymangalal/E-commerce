          ...
          <div className="w-full md:w-2/3 px-4">
           ...
           <p className="text-gray-700 mb-6  dark:text-white">
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <Button isLoading={addToWishlistLoading} onPress={()=> addProductWishlis (productDetails?._id , setAddToWishlistLoading)} className="bg-gray-200 text-gray-800 px-6 py-2 rounded-md">
                Wishlist
              </Button>
            </div>
