...
export default function ProductDetails() {  
 ...
 const [addToWishlistLoading,setAddToCartLoading] = useState(false);
    const {id} = useParams()   
          ...
          <div className="w-full md:w-2/3 px-4">
           ...
           <p className="text-gray-700 mb-6  dark:text-white">
            ...
            <div className="flex space-x-4 mb-6">
              ...
              <Button onPress={()=>addProductWishlist(productDetails?._id , setAddToCartLoading)} className="bg-gray-200 text-gray-800 px-6 py-2 rounded-md">
                Wishlist
              </Button>
            </div>
