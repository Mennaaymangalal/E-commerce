  ...
  return (
    <>
       <div className="mt-4 ">
            ...
            <Input isInvalid={touched.resetCode && errors.resetCode} errorMessage={errors.resetCode} name='resetCode' value={values.resetCode} onChange={handleChange} onBlur={handleBlur} className='md:col-span-2 w-full'  variant='faded' label="resetCode" type="text" />
