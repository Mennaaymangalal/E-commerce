...
export default function ResetCode() {
      ...
      const validationSchema = Yup.object({
        ...
        resetCode: Yup.string().required("reset Code is required").email("Invalid Reset Code").matches("^\d{6}$"),
  ...
  return (
    <>
       <div className="mt-4 ">
            ...
            <Input isInvalid={touched.resetCode && errors.resetCode} errorMessage={errors.resetCode} name='email'value={values.resetCode} onChange={handleChange} onBlur={handleBlur} className='md:col-span-2 w-full'  variant='faded' label="Email" type="password" />
