...
export default function UpdateUserPassword() {
  ...
  return (
    <>
        ...
        <Input isInvalid={touched.currentPassword && errors.currentPassword} errorMessage={errors.currentPassword} name='currentPassword' value={values.currentPassword} onChange={handleChange} onBlur={handleBlur} className='md:col-span-2 w-full'  
            variant='faded' 
