...
export default function UpdateUserPassword() {
 ...
 const {setIsLogedIn} = useContext(authContext)
  ...
  return (
    ...
    {errMessage && <p className='text-black dark:text-white text-small'>{errMessage} tpassword} className='text-red-500 underline dark:text-red-500 '> Forget Password?</a></p>}
    </div>
