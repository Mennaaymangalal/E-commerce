...
export default function Login() {
 ...
 const {setIsLogedIn} = useContext(authContext)
  ...
  return (
    ...
    {errMessage && <p className='text-black text-small'>{errMessage}  <a href='#' onClick={forgetpassword} className='text-red-500 underline dark:text-red-500 '>Forget Password?</a></p>}
    </div>
