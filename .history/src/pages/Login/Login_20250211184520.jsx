 ...
 const {setIsLogedIn} = useContext(authContext)
  ...
  return (
    ...
    {errMessage && <p className='text-red-500 text-small'>{errMessage}  </p>}
     ...
     <div className="w-2/3 flex lg:flex-row justify-between align-middle md:flex-col">
     
     <p className=' m-auto text-sm'>Don't have an account? <a href='#' onClick={signup} className='text-blue-600 underline dark:text-blue-500 '>Signup</a></p>
     <a href='#' onClick={forgetpassword} className='text-black underline dark:text-white '> Forget Password?</a>
     </div>
        </form>
      </div>
    </>
