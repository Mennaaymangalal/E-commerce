 ...
 const {setIsLogedIn}= useContext(authContext)
  ...
  return (
    <>
      ...
      <Input isInvalid={touched.email && errors.email} errorMessage={errors.email} name='email'value={values.email} onChange={handleChange} onBlur={handleBlur} className='md:col-span- w-full'  variant='faded' label="Email" type="email" />
