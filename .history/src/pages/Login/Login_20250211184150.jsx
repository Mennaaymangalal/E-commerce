...
export default function Login() {
 ...
 const {setIsLogedIn} = useContext(authContext)
  ...
  return (
    ...
    {errMessage && <p className='text-red-500 dark:text-white text-small'>{errMessage}  </p>}
    </div>
    <a href='#' onClick={forgetpassword} className='text-red-500 underline dark:text-red-500 '> Forget Password?</a>
