 ...
 const {setIsLogedIn}= useContext(authContext)
  ...
  return (
    <>
      ...
      <Input isInvalid={touched.email && errors.email} errorMessage={errors.email} name='email'value={values.email} onChange={handleChange} onBlur={handleBlur} className='md:col-span-2 w-f'  variant='faded' label="Email" type="email" />
