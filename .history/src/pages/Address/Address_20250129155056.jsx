...
export default function Address() {
  ...
  const validationSchema = Yup.object({
   ...
   Location: Yup.string().required("Name is required").min(3,"Name must be at leaste 3 charachters").max(20, "Name must be at most 20 charachters"),  
  ...
  return (
    <>
      ...
      <Input isInvalid={touched.Location && errors.name} errorMessage={errors.name} name='name' value={values.name}  onChange={handleChange} onBlur={handleBlur} className='md:col-span-2' variant='faded' label="Name" type="text" />
      <Input isInvalid={touched.City && errors.name} errorMessage={errors.name} name='name' value={values.name}  onChange={handleChange} onBlur={handleBlur} className='md:col-span-2' variant='faded' label="Name" type="text" />
