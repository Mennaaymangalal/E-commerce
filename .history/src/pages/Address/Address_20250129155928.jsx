...
export default function Address() {
  ...
  return (
    <>
      ...
      <Input isInvalid={touched.details && errors.details} errorMessage={errors.name} name='name' value={values.name}  onChange={handleChange} onBlur={handleBlur} className='md:col-span-2' variant='faded' label="Location" type="text" />    
