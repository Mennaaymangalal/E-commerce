...
export default function Address() {
  ...
  return (
    <>
      ...
      <Input  name='name' value={values.city}  onChange={handleChange} onBlur={handleBlur} className='md:col-span-2' variant='faded' label="City" type="text" />
      <Input  name='name' value={values.details}  onChange={handleChange} onBlur={handleBlur} className='md:col-span-2' variant='faded' label="Location" type="text" />
