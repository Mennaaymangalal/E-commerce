...
export default function Carts() {
 ...
 async function Chechout(){
     const {data} = await axios.post("https://ecommerce.routemisr.com/api/v1/orders/checkout-session/"+ )
  }
  ...
  return (
   ...
   <div className="flex justify-between align-middle">
    ...
    <div className="justify-center px-6 md:flex md:space-x-6 xl:px-0">
      ...
      {/* Subtotal Section */}
      <div className="sticky top-20 mt-6 h-full rounded-lg border  dark:bg-slate-900 bg-white p-6 shadow-md md:mt-0 md:w-1/3">
        ...
        <button onClick={Chechout} className="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600">
          Check out
        </button>
      </div>
    </div>
