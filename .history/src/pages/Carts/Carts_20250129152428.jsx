...
export default function Carts() {
   ...
   const [checkoutLoading , setIsLoading] = useState(false)
   ...
   <div className="flex justify-between align-middle">
    ...
    <div className="justify-center px-6 md:flex md:space-x-6 xl:px-0">
      ...
      <div className="sticky top-10 mt-6 h-full rounded-lg border  dark:bg-slate-900 bg-white p-6 shadow-md md:mt-0 md:w-1/3">
        ...
        <Button isLoading={} onPress={()=>Chechout()} className="mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600">
          Check out
        </Button>
      </div>
    </div>
