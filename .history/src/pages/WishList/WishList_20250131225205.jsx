...
export default function WishList() {
  ...
  className={`p-0 m-0 bg-transparent hover:bg-transparent focus:outline-none active:outline-none border-none shadow-none ${
    removingProductId === product.id ? "opacity-50 cursor-not-allowed" : ""
  }`}
  style={{
    display: "flex", // Ensures icon is centered if inside a container
    alignItems: "center",
    justifyContent: "center",
    width: "auto", // Prevents unnecessary button width
    height: "auto",
  }}
>
  {removingProductId === product.id ? (
    <i className="fas fa-spinner fa-spin"></i> // Spinner for loading state
  ) : (
