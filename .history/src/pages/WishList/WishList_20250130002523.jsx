...
export default function WishList() {
  ...
  <div className="">
    ...
    >
      ...
      <p className="text-dark my-2 line-clamp-1">{wishList.description}</p>  
      <p className="text-dark my-2 line-clamp-1">{wishList.title}</p>  
      <p className="text-dark my-4">price:{wishList.price}</p>     
