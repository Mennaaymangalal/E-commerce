...
export default function WishList() {
  ...
  className={`text-red-500 hover:text-red-700 bg-transparent hover:bg-transparent focus:outline-none active:outline-none border-none shadow-none w-full md:w-auto mt-2 md:mt-0 ${
    removingProductId === product.id ? "opacity-50 cursor-not-allowed" : ""
  }`}
>
  {removingProductId === product.id ? (
    <i className="fas fa-spinner fa-spin"></i> // Spinning icon when loading
  ) : (
