...
export default function WishList() {
  ...
  <div className="">
      ...
      className="bg-white dark:bg-slate-900 rounded-lg shadow-md p-4 flex flex-col items-start"
    >
     <div className=""> <img
      ...
      <p className="text-dark mb-1 line-clamp-1">{wishList.title}</p>  
      <p className="text-dark my-2 items-center">price:{formatCurrency(wishList.price)}</p>     
