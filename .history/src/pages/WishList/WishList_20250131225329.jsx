                ...
                <div className="flex flex-col md:flex-row md:space-x-2 w-full">
                  <div className=" flex justify-around align-middle w-full">
                    ...
                    <Button
                      ...
                      className={`text-red-500 hover:text-red-700 !bg-transparent hover:!bg-transparent focus:bg-transparent active:bg-transparent border-none shadow-none focus:ring-0 focus:outline-none active:ring-0 active:outline-none w-non md:w-auto mt-2 md:mt-0 ${
