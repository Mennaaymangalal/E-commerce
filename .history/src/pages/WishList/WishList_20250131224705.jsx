...
async function removeProductFromWishlist(productId) {
  ...
  className={`text-red-500 hover:text-red-700 !bg-transparent hover:!bg-transparent focus:bg-transparent active:bg-transparent border-none shadow-none w-full md:w-auto mt-2 md:mt-0 ${
