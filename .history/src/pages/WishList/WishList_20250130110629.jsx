...
export default function WishList() {
  ...
  <div className="">
      ...
      className="bg-white dark:bg-slate-900 rounded-lg shadow-md p-4 flex flex-col items-stretch"
    >
     <div className=""> <img
      ...
      <p className="text-dark my-2 ">price:{formatCurrency(wishList.price)}</p>     
