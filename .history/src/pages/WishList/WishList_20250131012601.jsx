...
function WishlistComponent() {
  ...
  const addProductMutation = useMutation(addProductWishlist, {
    onSuccess: () => {
      queryClient.invalidateQueries(["wishList"]); // Re-fetch wishlist data
    },
  });
  ...
  const removeProductMutation = useMutation(
      ...
      ),
    {
      onSuccess: (_, productId) => {
        ...
        // Call addProductWishlist after removing
