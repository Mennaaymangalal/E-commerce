              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:space-x-2 w-full">
                  <div className=" flex justify-around align-middle w-full">
                    ...
                    <Button
  onPress={() => handleRemoveFromWishlist(product._id)} // Your remove function
  disabled={removingProductId === product._id}
  className={`text-red-500 hover:text-red-700 bg-transparent border-none focus:ring-0 focus:outline-none w-full md:w-auto mt-2 md:mt-0 ${
    removingProductId === product._id ? "shadow-none opacity-50 cursor-not-allowed" : "shadow-md"
  }`}
>
