...
export default function WishList() {
  ...
  <div className="">
    ...
    >
      ...
      <p className="text-gray-500 my-2 line-clamp-1">{wishList.description}</p>  
      <p className="text-gray-500 my-2 line-clamp-1">{wishList.title}</p>  
      <p className="text-gray-500 my-4">price:{wishList.price}</p>     
