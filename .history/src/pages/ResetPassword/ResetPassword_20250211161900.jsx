...
export default function ResetPassword() {
  ...
  return (
    <>
       ...
       <Input isInvalid={touched.newPassword && errors.newPassword} errorMessage={errors.newPassword} name='newPassword' value={values.password} onChange={handleChange} onBlur={handleBlur} className='md:col-span-2 w-full'  variant='faded' label="Password" type="password" />
