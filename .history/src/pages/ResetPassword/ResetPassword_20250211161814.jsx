...
export default function ResetPassword() {
  ...
  return (
    <>
      ...
      'rePassword' value={values.rePassword} onChange={handleChange} onBlur={handleBlur} className='md:col-span-2 w-full' variant='faded' label="Confirm Password" type="password" />
