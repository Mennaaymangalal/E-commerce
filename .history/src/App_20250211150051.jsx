...
import UpdateLoggeduserpassword from "./pages/UpdateLoggeduserpassword/UpdateUserPassword";
import UpdateUserPassword from "./pages/UpdateLoggeduserpassword/UpdateUserPassword";
...
function App() {
  const router = createBrowserRouter([
    {path: "",element: <MainLayout />,children: [
        ...
        {path: "/updateloggeduserpassword",element: (<ProtectedLoginRouting><UpdateUserPassword /></ProtectedLoginRouting>),},
